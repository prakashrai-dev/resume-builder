...
setAllResumes(data.resumes)
  ...
  // Fixed: Implemented the logic to update the resume title
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex flex-wrap gap-4 sm:w-auto'>
        ...
        <hr className='border-slate-300 my-6 sm:w-[304px]' />
            ...
            return (
              ...
              >
                ...
                <div className='absolute top-1 right-1 group-hover:flex items-center hidden'>
                  {/* Fixed: Added event propagation stop to prevent navigation on click */}
                  <TrashIcon onClick={(e) => { e.stopPropagation(); deleteResume(resume._id); }} className='size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors' />
                  <PencilIcon onClick={(e) => { e.stopPropagation(); setEditResumeId(resume._id); setTitle(resume.title); }} className='size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors' />
                </div>
              </button>
            );
          })}
        ...
        {/* Fixed: Edit modal moved to the correct top-level position */}
        {editResumeId && (
          <form onSubmit={editTitle} onClick={() => { setEditResumeId(''); setTitle(''); }} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
