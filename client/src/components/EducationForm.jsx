                    ...
                    {data.map((education, index)=>(
                        <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                <input value={education.instituion || ""} onChange={(e)=>updateEducation(index,"instituion",e.target.value)} type="text" placeholder='Instituion Name' className='px-3 py-2 text-sm ' />
