        ...
        <div className='space-y-4'>
            ...
            {data.length > 0 ? (
                <div className='flex flex-wrap gap-2'>
                    {/* FIX: Added parentheses around the (skill, index) arguments */}
            ...
            <div className='bg-blue-50 p-3 rounded-lg'>
                <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relevant skills. Include both technical (programming languages, tools) and soft skills (leadership, communication).</p>
            </div>
        </div>
    )
}
